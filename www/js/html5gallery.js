...
function loadHtml5Gallery(s) {
    ...
    jQuery.extend(jQuery.easing, {
        ...
        easeInElastic: function(b, e, a, d, c) {
            ...
            if (1 == (e /= c)) return a + d;
            k || (k = 0.3 * c);
            f < Math.abs(d) ? (f = d, b = k / 4) : b = k / (2 * Math.PI) * Math.asin(d / f);
            return -(f * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * c - b) * 2 * Math.PI / k)) + a
        },
        easeOutElastic: function(b,
            ...
            k || (k = 0.3 * c);
            f < Math.abs(d) ? (f = d, b = k / 4) : b = k / (2 * Math.PI) * Math.asin(d / f);
            return f * Math.pow(2, -10 * e) * Math.sin((e * c - b) * 2 * Math.PI / k) + d + a
        },
        easeInOutElastic: function(b, e, a, d, c) {
            ...
            k || (k = c * 0.3 * 1.5);
            f < Math.abs(d) ? (f = d, b = k / 4) : b = k / (2 * Math.PI) * Math.asin(d / f);
            return 1 > e ? -0.5 * f * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * c - b) * 2 * Math.PI / k) + a : 0.5 * f * Math.pow(2, -10 * (e -= 1)) * Math.sin((e * c - b) * 2 * Math.PI /
                k) + d + a
        },
    ...
    w.fn.touchSwipe = function(b) {
        ...
        return this.each(function() {
            ...
            function b(a) {
                ...
                1 <= c.targetTouches.length ? (j = c.targetTouches[0].pageX, g = c.targetTouches[0].pageY) : k(a)
            }
        ...
        q = x.drag = {
            ...
            delegate: function(b) {
                ...
                m.each(d.live || [], function(c, d) {
                    if (0 === d.preType.indexOf("drag") && (a = m(b.target).closest(d.selector, b.currentTarget)[0])) v.add(a, d.origType + "." + q.livekey, d.origHandler, d.data), 0 > m.inArray(a, e) && e.push(a)
                });
            ...
            hijack: function(b, e, a, d, c) {
                if (a) {
                    ...
                    a.results = [];
                    do
                        if ((t = a.interactions[g]) && !("dragend" !== e && t.cancelled)) p = q.properties(b, a, t), t.results = [], m(c || t[h] || a.droppable).each(function(c, d) {
                                j = (p.target = d) ? v.handle.call(d, b, p) : null;
                                !1 === j ? ("drag" == h && (t.cancelled = !0, a.propagates -= 1), "drop" == e && (t[h][c] = null)) : "dropinit" == e && t.droppable.push(q.element(j) || d);
                                "dragstart" == e && (t.proxy = m(q.element(j) || t.drag)[0]);
                                t.results.push(j);
                                delete b.result;
                                if ("dropinit" !== e) return j
                            }), a.results[g] =
                            q.flatten(t.results), "dropinit" == e && (t.droppable = q.flatten(t.droppable)), "dragstart" == e && !t.cancelled && p.update();
                    while (++g < d);
                    b.type = f;
                    b.originalEvent = k;
            ...
            properties: function(b, e, a) {
                ...
                d.drop = q.flatten((a.drop || []).slice());
                d.available = q.flatten((a.droppable || []).slice());
                return d
            },
            element: function(b) {
    ...
    var B = jQuery;
    B.fn.html5boxTransition = function(b, e, a, d, c) {
        $parent = this;
        b = d.effect;
        var k = d.easing,
            f = d.duration,
        ...
        j && d[j] && ("duration" in d[j] && (f = d[j].duration), d[j].easing && (k = d[j].easing));
        "fade" == j || "fadein" == j ? (a.hide(), e.insertBefore(a), a.fadeIn(f, k, function() {
                e.remove();
                c()
            })) : "fadeout" == j ? (a.show(),
                e.fadeOut(f, k, function() {
                    e.remove();
                    c()
    ...
    l.fn.addHTML5VideoControls = function(b, e, a) {
        var d = "ontouchstart" in window,
            c = d ? "touchstart" : "mousedown",
            k = d ? "touchmove" : "mousemove",
            f = d ? "touchcancel" : "mouseup",
            h = d ? 48 : 36,
            j = null,
            g = null,
            t = !1,
        ...
        C.css({
            ...
            a = (d ? a.originalEvent.touches[0] : a).pageX - C.offset().left;
            r.css({
                width: a
            });
        ...
        if (n.get(0).volume === a / 2 + 0.1) {
            ...
            y.bind(c, function(a) {
                a = 1 - ((d ? a.originalEvent.touches[0] : a).pageY - y.offset().top) / y.height();
                a = 1 < a ? 1 : 0 > a ? 0 : a;
                M.css({
                    height: Math.round(100 * a) + "%"
                });
    ...
    b.fn.html5gallery = function(l) {
        var e = function(a, d, c) {
            ...
            this.options.googlefonts && 0 < this.options.googlefonts.length && (a = "https://fonts.googleapis.com/css?family=" + this.options.googlefonts, d = document.createElement("link"), d.setAttribute("rel", "stylesheet"), d.setAttribute("type", "text/css"), d.setAttribute("href", a), document.getElementsByTagName("head")[0].appendChild(d));
        ...
        e.prototype = {
            ...
            readTags: function() {
                ...
                (b("img.html5galleryimg", this.container).length ? b("img.html5galleryimg", this.container) : b("img", this.container)).each(function() {
                    ...
                    var h = a.options.width,
                        ...
                        z = null,
                        D = !1;
                    b(this).parent().is("a") && (c = b(this).parent().attr("href"), t = b(this).parent().data("ogg"),
                    ...
                    a.elemArray.push([a.elemArray.length, d, c, t, p, l, q, e, f, A, h, j, m, s, n, v, g, w, x, u, B, z, D])
                })
            },
            getYouTubePlaylist: function(a, d, c, e, f, h, j) {
                ...
                c &&
                    (g = 50 < c ? g + "&maxResults=50" : g + ("&maxResults=" + c));
                j && (g += "&pageToken=" + j);
                var t = !0;
            ...
            createStyleVertical: function() {
                ...
                var c = " .html5gallery-container-" + this.id + " { display:block; position:absolute; left:0px; top:0px; width:" + this.options.totalWidth + "px; height:" + this.options.totalHeight + "px; " + (!this.options.bgimage ? "" : "background:url('" + this.options.skinfolder + this.options.bgimage + "') center top;") + " background-color:" + this.options.bgcolor + ";}";
                ...
                var c = c + (" .html5gallery-box-" + this.id + " {display:block; position:absolute; text-align:center; left:" + this.options.boxLeft + "px; top:" + this.options.boxTop + "px; width:" + this.options.boxWidth + "px; height:" + this.options.boxHeight + "px; }"),
                    ...
                    c = c + (" .html5gallery-viral-" + this.id +
                    ...
                    c = this.options.titleoverlay ? "top" == this.options.headerpos ? c + "top:0px; height:auto; }" : c + "bottom:0px; height:auto; }" :
                    c + ("top:" + a + "px; height:" + this.options.titleheight + "px; }"),
                    ...
                    c = c + (" .html5gallery-elem-" + this.id + " {display:block; overflow:hidden; position:absolute; top:" + this.options.elemTop + "px; left:0px; width:" + this.options.boxWidth + "px; height:" + this.options.height + "px;}");
                this.options.isIE7 ||
                ...
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    if (1 == a || this.showingPoster) {
                        ...
                        b(".html5gallery-elem-image-" + this.id).css({
                            ...
                            this.elemArray[this.curElem][18] ? Math.min(this.elemArray[this.curElem][18], this.fullscreenHeight) : this.fullscreenHeight, e = Math.min(a / d, f / c), e = 1 < e ? 1 : e, a = Math.round(e * d), e = Math.round(e * c), this.adjustFullscreen(a, e, !0)) : (a = this.options.width, e = this.options.height), b(".html5gallery-elem-" + this.id).css({
                            width: a + "px",
                            height: e + "px"
                        }), b(".html5gallery-elem-video-" + this.id).css({
                            width: a + "px",
            ...
            createStyleDefault: function() {
                ...
                var d = 0,
                    c = 0;
                this.options.elemTop = 0;
                "top" == this.options.headerpos ? (c = 0, d = this.options.socialheight, this.options.elemTop = this.options.headerHeight) : "bottom" == this.options.headerpos && (this.options.elemTop = 0, d = this.options.titleoverlay ? this.options.height - this.options.titleheight : this.options.height, c = this.options.titleoverlay ?
                ...
                this.options.titleoverlay ? a = "top" == this.options.headerpos ? a + "top:0px; height:auto; }" : a + "bottom:0px; height:auto; }" :
                    (a += "top:" + d + "px; height:" + this.options.titleheight + "px; }", this.options.titlesmallscreen && (a += " @media (max-width: " + this.options.titlesmallscreenwidth + "px) { .html5gallery-title-" + this.id + " {height:" + this.options.titleheightsmallscreen + "px; }}"));
                ...
                for (var c =
                    ...
                    b(e).load(function() {
                        ...
                        a.options.carouselmultirows && "samecolumn" == a.options.thumbresponsive ? b("#html5gallery-tn-" + a.id + "-" + this.data, d).append("<div class='html5gallery-tn-img-" + a.id + "' style='position:relative;width:" + String(a.options.thumbimagewidth + 2 * a.options.thumbimageborder) + "px;height:" + String(a.options.thumbimageheight + 2 * a.options.thumbimageborder) + "px;'><div style='display:block; overflow:hidden; position:absolute; width:" + a.options.thumbimagewidth +
                            ...
                            e + "px; height:" + c + "px;' src='" + a.elemArray[this.data][1] + "' /></div>" + k + "</div><div class='html5gallery-tn-title-" + a.id + "'>" + a.elemArray[this.data][7] + (a.options.thumbshowdescription ? "<br /><span class='html5gallery-tn-description-" + a.id + "'>" + a.elemArray[this.data][8] + "</span>" : "") + "</div>");
            ...
            goFullscreen: function() {
                ...
                this.$fullscreen = b("<div class='html5gallery-fullscreen-" + this.id + "' style='position:absolute;top:0px;left:0px;width:" + a + "px;height:" + f + "px;text-align:center;z-index:99999;'><div class='html5gallery-fullscreen-overlay-" + this.id + "' style='display:block;position:absolute;top:0px;left:0px;width:100%;height:100%;background-color:#000000;opacity:0.9;filter:alpha(opacity=80);'></div><div class='html5gallery-fullscreen-box-" +
                    ...
                    this.id + "' style='display:none;position:absolute;cursor:pointer;width:48px;height:48px;left:" + this.fullscreenMargin + "px;top:" + Math.round(c / 2) + 'px;background-image:url("' + this.options.skinfolder + "lightbox_prev.png\");'></div></div></div>");
            ...
            slideRun: function(a, d, c, e) {
                ...
                if (!(0 > a)) {
                    ...
                    (5 == a || 6 == a || 7 == a || 8 == a || 9 == a || 10 == a || 11 == a) && !c && this.elemArray[this.curElem][12] ? (this.showingPoster = !0, this.showPoster()) : (b(".html5gallery-video-play-" + this.id,
                        j).length && b(".html5gallery-video-play-" + this.id, j).remove(), 1 == a ? this.showImage() : 5 == a || 6 == a || 7 == a || 8 == a ? this.showVideo(c, e) : 9 == a ? this.showYoutube(c) : 10 == a ? this.showVimeo(c) : 11 == a ? this.showEmbedVideo(c) : 2 == a ? this.showSWF() : 12 == a && this.showIframe());
                    ...
                    this.prevElem in
                        this.elemArray && (!this.options.autoplayvideo && this.elemArray[this.prevElem][12]) && ((new Image).src = this.elemArray[this.prevElem][12]);
                    ...
                    this.elemArray[this.curElem][5] ||
                        (this.options.lightbox || this.elemArray[this.curElem][22]) && !this.isFullscreen ? (d.css({
                            cursor: "pointer"
            ...
            showImage: function() {
                ...
                b(c).load(function() {
                    ...
                    var c;
                    if (d.isFullscreen) {
                        var e = d.elemArray[d.curElem][17] ? Math.min(d.elemArray[d.curElem][17], d.fullscreenWidth) : d.fullscreenWidth;
                        c = d.elemArray[d.curElem][18] ?
                            Math.min(d.elemArray[d.curElem][18], d.fullscreenHeight) : d.fullscreenHeight;
                    ...
                    var h = d.isFullscreen ? e : d.options.width,
                        j = d.isFullscreen ? c : d.options.height,
                        g = Math.round(h / 2 - e / 2),
                        l = Math.round(j / 2 - c / 2);
                    d.isFullscreen && d.adjustFullscreen(h,
                        j);
                    a.css({
                        width: h,
                        height: j
                    ...
                    e = b("<div class='html5gallery-elem-img-" + d.id + "' style='display:block; position:absolute; overflow:hidden; width:" + h + "px; height:" + j + "px; left:0px; margin-left:" + (d.options.slideshadow && !d.isFullscreen ? 4 : 0) + "px; top:0px; margin-top:" + (d.options.slideshadow && !d.isFullscreen ? 4 : 0) + "px;'><img class='html5gallery-elem-image-" + d.id + "' style='border:none; position:absolute; opacity:inherit; filter:inherit; padding:0px; margin:0px; left:" + g + "px; top:" + l + "px; max-width:none; max-height:none; width:" +
                        e + "px; height:" + c + "px;' src='" + d.elemArray[d.curElem][2] + "' />" + d.options.watermarkcode + "</div>");
            ...
            showPoster: function() {
                ...
                b(h).load(function() {
                    $preloading.remove();
                    var h, g, l;
                    c.isFullscreen ? (g = c.elemArray[c.curElem][17] ? Math.min(c.elemArray[c.curElem][17], c.fullscreenWidth) : Math.min(e, c.fullscreenWidth),
                        l = c.elemArray[c.curElem][18] ? Math.min(c.elemArray[c.curElem][18], c.fullscreenHeight) : Math.min(f, c.fullscreenHeight), h = Math.max(g / this.width, l / this.height), h = 1 < h ? 1 : h) : (h = "fill" == c.options.resizemode ? Math.max(c.options.width / this.width, c.options.height / this.height) : Math.min(c.options.width / this.width, c.options.height / this.height), g = c.options.width, l = c.options.height);
                    var p = Math.round(h * this.width);
                    h = Math.round(h * this.height);
                    var q = Math.round(g / 2 - p / 2),
                        m = Math.round(l / 2 - h / 2);
                    c.isFullscreen && c.adjustFullscreen(g,
                        l);
                    d.css({
                        width: g,
                        height: l
                    ...
                    g = b("<div class='html5gallery-elem-img-" + c.id + "' style='display:block; position:absolute; overflow:hidden; width:" + g + "px; height:" + l + "px; left:0px; margin-left:" + (c.options.slideshadow && !c.isFullscreen ? 4 : 0) + "px; top:0px; margin-top:" + (c.options.slideshadow && !c.isFullscreen ? 4 : 0) + "px;'><img class='html5gallery-elem-image-" + c.id + "' style='border:none; position:absolute; opacity:inherit; filter:inherit; padding:0px; margin:0px; left:" + q + "px; top:" + m + "px; max-width:none; max-height:none; width:" +
                        p + "px; height:" + h + "px;' src='" + c.elemArray[c.curElem][12] + "' />" + c.options.watermarkcode + "</div>");
                    l = b(".html5gallery-elem-img-" + c.id, d);
                    l.length ? (d.prepend(g), d.html5boxTransition(c.id, l, g, {
                    ...
                    b(".html5gallery-video-play-" + c.id, a).length || b("<div class='html5gallery-video-play-" + c.id + "' style='position:absolute;display:block;cursor:pointer;top:50%;left:50%;width:64px;height:64px;margin-left:-32px;margin-top:-32px;background:url(\"" +
                        c.options.skinfolder + "playvideo_64.png\") no-repeat center center;'></div>").appendTo(d).unbind(c.eClick).bind(c.eClick, function() {
                        b(this).remove();
                ...
                b(h).error(function() {
                    $preloading.remove();
                    c.isFullscreen &&
                        c.adjustFullscreen(c.options.width, c.options.height);
                    d.html("<div class='html5gallery-elem-error-" + c.id + "' style='display:block; position:absolute; overflow:hidden; text-align:center; width:" + c.options.width + "px; left:0px; top:" + Math.round(c.options.height / 2 - 10) + "px; margin:4px;'><div class='html5gallery-error-" + c.id + "'>The requested content cannot be found</div>");
            ...
            showVideo: function(a, d) {
                ...
                h = -1;
                d && b(".html5gallery-elem-" + this.id, c).find("video").length && (h = b(".html5gallery-elem-" + this.id, c).find("video:first").get(0).currentTime);
                b(".html5gallery-elem-" + this.id, c).html("<div class='html5gallery-loading-center-" + this.id + "'></div><div class='html5gallery-elem-video-" + this.id + "' style='display:block;position:absolute;overflow:hidden;top:" + (this.options.slideshadow &&
                    !this.isFullscreen ? 4 : 0) + "px;left:" + (this.options.slideshadow && !this.isFullscreen ? 4 : 0) + "px;width:" + f + "px;height:" + e + "px;'></div>" + this.options.watermarkcode);
                this.isHTML5 = !1;
            ...
            showSWF: function() {
                ...
                this.isFullscreen ? this.adjustFullscreen(d,
                    c) : b(".html5gallery-elem-" + this.id, this.$gallery).css({
                    width: this.options.width,
                    height: this.options.height
                });
                ...
                b(".html5gallery-elem-" + this.id, a).html("<div class='html5gallery-elem-flash-" + this.id + "' style='display:block;position:absolute;overflow:hidden;top:" + e + "px;left:" + f + "px;width:" + d + "px;height:" + c + "px;'></div>" +
                    this.options.watermarkcode);
                this.embedFlash(b(".html5gallery-elem-flash-" + this.id, a), d, c, this.elemArray[this.curElem][2], "window", {}, "html5gallery-elem-flash-object-" + this.id);
            ...
            showYoutube: function(a) {
                a && this.options.autoslideandplayafterfirstplayed && (this.options.autoplayvideo = !0, this.isPaused = !1);
                var d = this.isFullscreen ? this.$fullscreen :
                    this.$gallery,
                    c = this.elemArray[this.curElem][10],
                    e = this.elemArray[this.curElem][11];
                if (this.isFullscreen) {
                    ...
                    e = this.options.width, c = this.options.height;
                f = this.elemArray[this.curElem][2];
                b(".html5gallery-elem-" + this.id, d).html("<div class='html5gallery-loading-center-" + this.id + "'></div><div id='html5gallery-elem-video-" + this.id + "' style='display:block;position:absolute;overflow:hidden;top:" + (this.options.slideshadow && !this.isFullscreen ? 4 : 0) + "px;left:" + (this.options.slideshadow && !this.isFullscreen ? 4 : 0) + "px;width:" + e + "px;height:" + c + "px;'></div>" + this.options.watermarkcode);
                var h = this;
                ...
                if (ASYouTubeIframeAPIReady && !this.options.isMobile && !this.options.isIE6 && !this.options.isIE7) {
                    ...
                    this.id, d).html("<iframe width='" + e + "' height='" + c + "' src='" + f + "' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>");
                this.options.googleanalyticsaccount && window._gaq && window._gaq.push(["_trackEvent", "Video", "Play", this.elemArray[this.curElem][2]])
            },
            ...
            showIframe: function() {
                ...
                b(".html5gallery-elem-" + this.id, a).html("<div class='html5gallery-loading-center-" + this.id +
                    "'></div><div class='html5gallery-elem-iframe-" + this.id + "' style='display:block;position:absolute;overflow:hidden;top:" + (this.options.slideshadow && !this.isFullscreen ? 4 : 0) + "px;left:" + (this.options.slideshadow && !this.isFullscreen ? 4 : 0) + "px;width:" + c + "px;height:" + d + "px;'></div>" + this.options.watermarkcode);
            ...
            embedHTML5Video: function(a,
                d, c, e, f, h, j, g) {
                a.html("<div class='html5gallery-elem-video-container-" + this.id + "' style='position:relative;display:block;background-color:#000;width:" + d + "px;height:" + c + "px;'><video id='html5gallery-elem-html5-video-" + this.id + "' width='" + d + "px' height='" + c + "px'" + (this.options.nativehtml5controls && !this.options.videohidecontrols ? " controls" : "") + "></div>");
            ...
            embedFlash: function(a, b, c, e, f, h, j) {
                if (this.options.flashInstalled) {
                    ...
                    window.HTML5GallerySWFObject.embedSWF(e, j, b, c, "9.0.0", !1, h, g, {})
        ...
        this.each(function() {
            var a = b(this);
            l = l || {};
            for (var d in l) d.toLowerCase() !== d && (l[d.toLowerCase()] = l[d], delete l[d]);
            if ((!b(this).data("donotinit") || l && l.forceinit) && !b(this).data("inited")) {
                ...
                var k = {
                    ...
                    m = "vertical" == this.options.skin ? b.extend(m, q) : "showcase" == this.options.skin ? b.extend(m, p) : "light" == this.options.skin ? b.extend(m, k) : "gallery" == this.options.skin ? b.extend(m, h) : "gallerywithtext" == this.options.skin ? b.extend(m, j) : "horizontal" == this.options.skin ? b.extend(m, d) : "darkness" == this.options.skin ? b.extend(m, g) : "mediapage" == this.options.skin ? b.extend(m, f) : b.extend(m, d);
                ...
                for (d = 0; d < f.length; d++) k += String.fromCharCode(f[d]);
                this.options.fvm = k;
                f = "hmtamgli5cboxh.iclolms";
                for (d = 1; 5 >= d; d++) f = f.slice(0, d) + f.slice(d + 1);
                k = f.length;
                for (d = 0; 5 > d; d++) f = f.slice(0, k - 9 + d) + f.slice(k - 8 + d); - 1 != this.options.htmlfolder.indexOf(f) && (this.options.fv = !1);
                k = b(window).width();
                if (this.options.screenquery)
                    for (d in this.options.screenquery) k <= this.options.screenquery[d].screenwidth &&
                        (this.options.screenquery[d].gallerywidth && (this.options.width = this.options.screenquery[d].gallerywidth), this.options.screenquery[d].galleryheight && (this.options.height = this.options.screenquery[d].galleryheight), this.options.screenquery[d].thumbwidth && (this.options.thumbwidth = this.options.screenquery[d].thumbwidth), this.options.screenquery[d].thumbheight && (this.options.thumbheight = this.options.screenquery[d].thumbheight));
                "galleryid" in this.options ? d = this.options.galleryid : (d = G, G++);
                k = new e(a, this.options,
                    d);
...
function HTML5GallerySWFObjectFunc() {
        ...
        if (0 < b)
            for (var d = 0; d < b; d++) {
                ...
                if (0 < r.pv[0]) {
                    var k = e(g);
                    if (k)
                        if (a(I[d].swfVersion) && !(r.wk && 312 > r.wk)) c(g, !0), h && (j.success = !0, j.ref = x(g), h(j));
                        else if (I[d].expressInstall && q()) {
                        j = {};
                        j.data = I[d].expressInstall;
    ...
    function c(a, b) {
        if (C) {
            ...
            z && e(a) ? e(a).style.visibility = c : d("#" + a, "visibility:" + c)
        }
    }
    ...
    return {
        ...
        embedSWF: function(b, d, e, g, j, k, l, m, n, p) {
            var t = {
                success: !1,
                id: d
            };
            r.w3 && !(r.wk && 312 > r.wk) && b && d && e && g && j ? (c(d, !1), w(function() {
                e += "";
                g += "";
                var r = {};
                if (n && typeof n === h)
                ...
                if (l && typeof l === h)
                    for (var v in l) s.flashvars = typeof s.flashvars != f ? s.flashvars +
                        ("&" + v + "=" + l[v]) : v + "=" + l[v];
                if (a(j)) u = G(r, s, d), r.id == d && c(d, !0), t.success = !0, t.ref = u;
                else {
                    if (k && q()) {
                        r.data = k;
                        B(r, s, d, p);
        ...
        expressInstallCallback: function() {
            if (D) {
                var a = e(g);
                a && P && (a.parentNode.replaceChild(P, a), J && (c(J, !0), r.ie && r.win && (P.style.display = "block")), u && u(Q));
                D = !1
            }
        }
    }
